...
export default function PlanDetailPage({ plan, onNavigate }) {
  ...
  const [documentLink, setDocumentLink] = useState(plan.documentLink  || '');
  ...
  const handleSave = () => {
    updatePlan(plan.id, { title: title.trim(), summary: summary.trim(), notes: notes.trim(), category, status, sections, documentLink: documentLink.trim() || null });
    setIsEditing(false);
  ...
  const handleCancel = () => {
    ...
    setDocumentLink(plan.documentLink || '');
    setIsEditing(false);
  };
          ...
          <>
            ...
            {documentLink && (
              <div style={{ marginBottom: 28 }}>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: C.fg3, marginBottom: 8 }}>Document</div>
                <a href={documentLink} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 500, color: C.accent, background: C.accentBg, border: `1px solid ${alpha(C.accent, 33)}`, borderRadius: 7, padding: '9px 16px', textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 28 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: C.fg3, marginTop: 4 }}>
                Paste a shareable link to any document
              </div>
            </div>
