    ...
    <div className="page-pad" style={{ background: C.bg0 }}>
      ...
      <div className="filter-scroll" style={{ marginBottom: 20 }}>
        <button onClick={() => setCatFilter('')}
          style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, padding: '5px 12px', borderRadius: 999, border: `1px solid ${!catFilter ? alpha(C.accent, 44) : C.border}`, background: !catFilter ? C.accentBg : 'transparent', color: !catFilter ? C.accent : C.fg3, cursor: 'pointer', fontWeight: !catFilter ? 500 : 400, whiteSpace: 'nowrap', flexShrink: 0 }}>
          All Categories
        </button>
