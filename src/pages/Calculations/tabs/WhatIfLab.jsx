...
//   - the bar's value is rendered IN ₹ (or %, for IRR) inside the bar
//   - a ±% summary on the far right shows the swing as a fraction of base
...
export default function WhatIfLab({ input, calc }) {
  ...
  // Sort drivers by max absolute impact in the chosen metric.
  ...
  // Insight footer copy — driven by the top driver and how dominant it is.
  const top = sorted[0];
  ...
  return (
    <div className="calc-whatif">
      ...
      {/* Header — title, base value, metric toggle */}
        ...
        {sorted.map((r, i) => {
          ...
          return (
            <div key={r.key} className="calc-whatif-row">
              {/* Label cell with optional TOP badge */}
