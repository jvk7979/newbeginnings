  ...
  return (
    <>
      ...
      {viewing && (isPdf || resolvedUrl || file.url) && createPortal(
        <div role="dialog" aria-modal="true" aria-label={`Document viewer: ${file.name || file.fileName || 'attachment'}`}
             style={{ position: 'fixed', inset: 0, zIndex: 10000, display: 'flex', flexDirection: 'column', background: '#1a1510', overscrollBehavior: 'contain' }}>
